...
<?php if(strlen($_SESSION['login']))
    {   ?>
				...
				<?php } ?>
					...
					<li><a href="https://icar0028.herokuapp.com/"><i class="icon fa fa-sign-in"></i>Group Chat</a></li>
					<li><a href="my-cart.php"><i class="icon fa fa-shopping-cart"></i>My Cart</a></li>
					<li><a href="admin/index.php"><i class="icon fa fa-sign-in"></i>Admin Login</a></li>
